...
public final class ModEvents {
  ...
  public static void register() {
    ...
    GameClientEvents.MOUSE_TURN_PLAYER.on(
        e -> {
          if (PerspectiveAPI.isCurrent(FreeThirdPersonPerspective.ID)) {
    ...
    GameClientEvents.MOUSE_TURN_PLAYER.on(
        e -> {
          if (PerspectiveAPI.isCurrent(FreeCameraPerspective.ID)) {
    ...
    GameClientEvents.HANDLE_KEYBINDS_START.on(
        (minecraft) -> {
          if (!PerspectiveAPI.isCurrent(FreeCameraPerspective.ID)) return;
